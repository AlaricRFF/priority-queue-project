...
/*
 * Compile this test against your .h files to make sure they compile. Note
 * how the eecs281 priority queues can be constructed with the different
 * types. We suggest adding to this file or creating your own test cases to
 * test your priority queue implementations more thoroughly. If you do not
 * call a function from here, it is NOT compiled due to templates! So for
 * instance, if you don't add code to call updatePriorities(), you could have
 * compiler errors that you don't even know about.
 *
 * Our makefile will build an executable named testPQ if you type 'make
 * testPQ' or 'make alltests' (without the quotes).
 *
